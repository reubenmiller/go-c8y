...
func TestListPlucksReferences(t *testing.T) {
	...
	if path != "/inventory/managedObjects/100/childAssets" {
...
func TestGetReturnsNestedManagedObject(t *testing.T) {
	...
	if path != "/inventory/managedObjects/100/childAssets/77" {
...
func TestCreatePostsManagedObject(t *testing.T) {
	...
	if method != http.MethodPost || path != "/inventory/managedObjects/100/childAssets" {
...
func TestUnassignDeletesByPath(t *testing.T) {
	...
	if method != http.MethodDelete || path != "/inventory/managedObjects/100/childAssets/55" {
		t.Errorf("unassign = %s %s, want DELETE .../childAssets/55", method, path)
	}
	if bodyLen != 0 {
