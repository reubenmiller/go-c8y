...
func (s *Service) Delete(ctx context.Context, pluginID string, version string) (*resty.Response, error) {
	return core.ExecuteResponseOnly(ctx, s.deleteB(pluginID, version))
}
