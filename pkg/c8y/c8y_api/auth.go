...
func DecodeBasicAuth(auth string, host string) (*BasicAuthCredentials, error) {
...
type RequestAuthFunc func(req *resty.Request) (bool, error)
...
func WithAuthSequence(authFuncs ...RequestAuthFunc) RequestAuthFunc {
	return func(req *resty.Request) (bool, error) {
