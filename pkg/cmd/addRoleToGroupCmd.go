...
func (n *addRoleToGroupCmd) addRoleToGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doAddRoleToGroup(req, outputfile, filters)
}

func (n *addRoleToGroupCmd) doAddRoleToGroup(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
