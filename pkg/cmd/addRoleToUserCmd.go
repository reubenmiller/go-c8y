...
func (n *addRoleToUserCmd) addRoleToUser(cmd *cobra.Command, args []string) error {
	...
	return n.doAddRoleToUser(req, outputfile, filters)
}

func (n *addRoleToUserCmd) doAddRoleToUser(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
