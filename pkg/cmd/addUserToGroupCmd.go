...
func (n *addUserToGroupCmd) addUserToGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doAddUserToGroup(req, outputfile, filters)
}

func (n *addUserToGroupCmd) doAddUserToGroup(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
