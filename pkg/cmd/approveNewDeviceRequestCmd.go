...
func (n *approveNewDeviceRequestCmd) approveNewDeviceRequest(cmd *cobra.Command, args []string) error {
	...
	return n.doApproveNewDeviceRequest(req, outputfile, filters)
}

func (n *approveNewDeviceRequestCmd) doApproveNewDeviceRequest(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
