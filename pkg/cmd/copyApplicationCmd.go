...
func (n *copyApplicationCmd) copyApplication(cmd *cobra.Command, args []string) error {
	...
	return n.doCopyApplication("POST", path, queryValue, body.GetMap(), filters)
}

func (n *copyApplicationCmd) doCopyApplication(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
