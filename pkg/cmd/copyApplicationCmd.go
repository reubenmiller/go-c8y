...
func (n *copyApplicationCmd) copyApplication(cmd *cobra.Command, args []string) error {
	...
	return n.doCopyApplication(req, outputfile, filters)
}

func (n *copyApplicationCmd) doCopyApplication(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
