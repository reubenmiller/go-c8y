...
func (n *currentTenantCmd) currentTenant(cmd *cobra.Command, args []string) error {
	...
	return n.doCurrentTenant(req, outputfile, filters)
}

func (n *currentTenantCmd) doCurrentTenant(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
