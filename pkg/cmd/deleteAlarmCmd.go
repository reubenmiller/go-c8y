...
func (n *deleteAlarmCmd) deleteAlarm(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteAlarm("DELETE", path, queryValue, body.GetMap(), filters)
}

func (n *deleteAlarmCmd) doDeleteAlarm(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
