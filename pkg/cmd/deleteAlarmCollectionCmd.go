...
func (n *deleteAlarmCollectionCmd) deleteAlarmCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteAlarmCollection(req, outputfile, filters)
}

func (n *deleteAlarmCollectionCmd) doDeleteAlarmCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
