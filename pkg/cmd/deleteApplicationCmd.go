...
func (n *deleteApplicationCmd) deleteApplication(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteApplication(req, outputfile, filters)
}

func (n *deleteApplicationCmd) doDeleteApplication(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
