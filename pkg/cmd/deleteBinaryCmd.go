...
func (n *deleteBinaryCmd) deleteBinary(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteBinary("DELETE", path, queryValue, body.GetMap(), filters)
}

func (n *deleteBinaryCmd) doDeleteBinary(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
