...
func (n *deleteBinaryCmd) deleteBinary(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteBinary(req, outputfile, filters)
}

func (n *deleteBinaryCmd) doDeleteBinary(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
