...
func (n *deleteEventBinaryCmd) deleteEventBinary(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteEventBinary("DELETE", path, queryValue, body.GetMap(), filters)
}

func (n *deleteEventBinaryCmd) doDeleteEventBinary(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
