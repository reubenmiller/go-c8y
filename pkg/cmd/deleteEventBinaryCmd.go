...
func (n *deleteEventBinaryCmd) deleteEventBinary(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteEventBinary(req, outputfile, filters)
}

func (n *deleteEventBinaryCmd) doDeleteEventBinary(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
