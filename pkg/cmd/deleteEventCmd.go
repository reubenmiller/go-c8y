...
func (n *deleteEventCmd) deleteEvent(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteEvent("DELETE", path, queryValue, body.GetMap(), filters)
}

func (n *deleteEventCmd) doDeleteEvent(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
