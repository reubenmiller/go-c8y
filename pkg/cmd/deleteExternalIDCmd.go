...
func (n *deleteExternalIDCmd) deleteExternalID(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteExternalID(req, outputfile, filters)
}

func (n *deleteExternalIDCmd) doDeleteExternalID(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
