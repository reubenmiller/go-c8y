...
func (n *deleteManagedObjectChildAssetReferenceCmd) deleteManagedObjectChildAssetReference(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteManagedObjectChildAssetReference(req, filters)
}

func (n *deleteManagedObjectChildAssetReferenceCmd) doDeleteManagedObjectChildAssetReference(req c8y.RequestOptions, filters *JSONFilters) error {
