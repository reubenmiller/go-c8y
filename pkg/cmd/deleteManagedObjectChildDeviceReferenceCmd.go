...
func (n *deleteManagedObjectChildDeviceReferenceCmd) deleteManagedObjectChildDeviceReference(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteManagedObjectChildDeviceReference(req, filters)
}

func (n *deleteManagedObjectChildDeviceReferenceCmd) doDeleteManagedObjectChildDeviceReference(req c8y.RequestOptions, filters *JSONFilters) error {
