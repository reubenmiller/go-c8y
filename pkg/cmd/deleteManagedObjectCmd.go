...
func (n *deleteManagedObjectCmd) deleteManagedObject(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteManagedObject(req, outputfile, filters)
}

func (n *deleteManagedObjectCmd) doDeleteManagedObject(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
