...
func (n *deleteManagedObjectCmd) deleteManagedObject(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteManagedObject("DELETE", path, queryValue, body.GetMap())
}

func (n *deleteManagedObjectCmd) doDeleteManagedObject(method string, path string, query string, body map[string]interface{}) error {
