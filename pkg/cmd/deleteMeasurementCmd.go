...
func (n *deleteMeasurementCmd) deleteMeasurement(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteMeasurement("DELETE", path, queryValue, body.GetMap(), filters)
}

func (n *deleteMeasurementCmd) doDeleteMeasurement(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
