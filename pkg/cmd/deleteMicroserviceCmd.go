...
func (n *deleteMicroserviceCmd) deleteMicroservice(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteMicroservice(req, outputfile, filters)
}

func (n *deleteMicroserviceCmd) doDeleteMicroservice(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
