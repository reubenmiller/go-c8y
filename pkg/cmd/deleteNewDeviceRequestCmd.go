...
func (n *deleteNewDeviceRequestCmd) deleteNewDeviceRequest(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteNewDeviceRequest(req, outputfile, filters)
}

func (n *deleteNewDeviceRequestCmd) doDeleteNewDeviceRequest(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
