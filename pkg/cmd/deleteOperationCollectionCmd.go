...
func (n *deleteOperationCollectionCmd) deleteOperationCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteOperationCollection("DELETE", path, queryValue, body.GetMap(), filters)
}

func (n *deleteOperationCollectionCmd) doDeleteOperationCollection(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
