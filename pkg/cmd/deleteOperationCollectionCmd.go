...
func (n *deleteOperationCollectionCmd) deleteOperationCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteOperationCollection(req, filters)
}

func (n *deleteOperationCollectionCmd) doDeleteOperationCollection(req c8y.RequestOptions, filters *JSONFilters) error {
