...
func (n *deleteOperationCollectionCmd) deleteOperationCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteOperationCollection(req, outputfile, filters)
}

func (n *deleteOperationCollectionCmd) doDeleteOperationCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
