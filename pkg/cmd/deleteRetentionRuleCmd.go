...
func (n *deleteRetentionRuleCmd) deleteRetentionRule(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteRetentionRule(req, outputfile, filters)
}

func (n *deleteRetentionRuleCmd) doDeleteRetentionRule(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
