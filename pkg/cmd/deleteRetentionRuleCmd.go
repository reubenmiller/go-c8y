...
func (n *deleteRetentionRuleCmd) deleteRetentionRule(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteRetentionRule("DELETE", path, queryValue, body.GetMap(), filters)
}

func (n *deleteRetentionRuleCmd) doDeleteRetentionRule(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
