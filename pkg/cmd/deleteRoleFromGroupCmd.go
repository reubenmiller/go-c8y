...
func (n *deleteRoleFromGroupCmd) deleteRoleFromGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteRoleFromGroup(req, outputfile, filters)
}

func (n *deleteRoleFromGroupCmd) doDeleteRoleFromGroup(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
