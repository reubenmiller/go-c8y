...
func (n *deleteRoleFromUserCmd) deleteRoleFromUser(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteRoleFromUser(req, outputfile, filters)
}

func (n *deleteRoleFromUserCmd) doDeleteRoleFromUser(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
