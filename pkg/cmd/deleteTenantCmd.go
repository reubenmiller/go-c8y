...
func (n *deleteTenantCmd) deleteTenant(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteTenant("DELETE", path, queryValue, body.GetMap(), filters)
}

func (n *deleteTenantCmd) doDeleteTenant(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
