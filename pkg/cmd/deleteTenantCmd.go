...
func (n *deleteTenantCmd) deleteTenant(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteTenant(req, outputfile, filters)
}

func (n *deleteTenantCmd) doDeleteTenant(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
