...
func (n *deleteTenantOptionCmd) deleteTenantOption(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteTenantOption("DELETE", path, queryValue, body.GetMap(), filters)
}

func (n *deleteTenantOptionCmd) doDeleteTenantOption(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
