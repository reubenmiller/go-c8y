...
func (n *deleteUserCmd) deleteUser(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteUser("DELETE", path, queryValue, body.GetMap(), filters)
}

func (n *deleteUserCmd) doDeleteUser(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
