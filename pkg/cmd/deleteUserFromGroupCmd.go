...
func (n *deleteUserFromGroupCmd) deleteUserFromGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteUserFromGroup(req, outputfile, filters)
}

func (n *deleteUserFromGroupCmd) doDeleteUserFromGroup(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
