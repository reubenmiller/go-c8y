...
func (n *disableApplicationFromTenantCmd) disableApplicationFromTenant(cmd *cobra.Command, args []string) error {
	...
	return n.doDisableApplicationFromTenant(req, outputfile, filters)
}

func (n *disableApplicationFromTenantCmd) doDisableApplicationFromTenant(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
