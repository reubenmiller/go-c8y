...
func (n *disableMicroserviceCmd) disableMicroservice(cmd *cobra.Command, args []string) error {
	...
	return n.doDisableMicroservice(req, outputfile, filters)
}

func (n *disableMicroserviceCmd) doDisableMicroservice(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
