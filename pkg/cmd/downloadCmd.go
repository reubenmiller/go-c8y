...
func (n *downloadCmd) download(cmd *cobra.Command, args []string) error {
	...
	return n.doDownload("Get", path, queryValue, body.GetMap(), filters)
}

func (n *downloadCmd) doDownload(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
