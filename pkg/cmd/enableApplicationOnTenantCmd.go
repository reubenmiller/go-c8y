...
func (n *enableApplicationOnTenantCmd) enableApplicationOnTenant(cmd *cobra.Command, args []string) error {
	...
	return n.doEnableApplicationOnTenant(req, filters)
}

func (n *enableApplicationOnTenantCmd) doEnableApplicationOnTenant(req c8y.RequestOptions, filters *JSONFilters) error {
