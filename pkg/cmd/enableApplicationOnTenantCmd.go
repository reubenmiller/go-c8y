...
func (n *enableApplicationOnTenantCmd) enableApplicationOnTenant(cmd *cobra.Command, args []string) error {
	...
	return n.doEnableApplicationOnTenant(req, outputfile, filters)
}

func (n *enableApplicationOnTenantCmd) doEnableApplicationOnTenant(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
