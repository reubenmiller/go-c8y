...
func (n *getAllTenantUsageStatisticsSummaryCollectionCmd) getAllTenantUsageStatisticsSummaryCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetAllTenantUsageStatisticsSummaryCollection("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getAllTenantUsageStatisticsSummaryCollectionCmd) doGetAllTenantUsageStatisticsSummaryCollection(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
