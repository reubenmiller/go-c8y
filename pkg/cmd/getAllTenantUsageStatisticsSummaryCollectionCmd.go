...
func (n *getAllTenantUsageStatisticsSummaryCollectionCmd) getAllTenantUsageStatisticsSummaryCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetAllTenantUsageStatisticsSummaryCollection(req, filters)
}

func (n *getAllTenantUsageStatisticsSummaryCollectionCmd) doGetAllTenantUsageStatisticsSummaryCollection(req c8y.RequestOptions, filters *JSONFilters) error {
