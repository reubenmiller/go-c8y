...
func (n *getAllTenantUsageStatisticsSummaryCollectionCmd) getAllTenantUsageStatisticsSummaryCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetAllTenantUsageStatisticsSummaryCollection(req, outputfile, filters)
}

func (n *getAllTenantUsageStatisticsSummaryCollectionCmd) doGetAllTenantUsageStatisticsSummaryCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
