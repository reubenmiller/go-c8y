...
func (n *getApplicationBootstrapUserCmd) getApplicationBootstrapUser(cmd *cobra.Command, args []string) error {
	...
	return n.doGetApplicationBootstrapUser(req, filters)
}

func (n *getApplicationBootstrapUserCmd) doGetApplicationBootstrapUser(req c8y.RequestOptions, filters *JSONFilters) error {
