...
func (n *getApplicationCmd) getApplication(cmd *cobra.Command, args []string) error {
	...
	return n.doGetApplication(req, outputfile, filters)
}

func (n *getApplicationCmd) doGetApplication(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
