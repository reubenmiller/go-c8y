...
func (n *getApplicationCollectionCmd) getApplicationCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetApplicationCollection(req, filters)
}

func (n *getApplicationCollectionCmd) doGetApplicationCollection(req c8y.RequestOptions, filters *JSONFilters) error {
