...
func (n *getApplicationCollectionCmd) getApplicationCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetApplicationCollection(req, outputfile, filters)
}

func (n *getApplicationCollectionCmd) doGetApplicationCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
