...
func (n *getApplicationReferenceCollectionCmd) getApplicationReferenceCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetApplicationReferenceCollection(req, outputfile, filters)
}

func (n *getApplicationReferenceCollectionCmd) doGetApplicationReferenceCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
