...
func (n *getApplicationReferenceCollectionCmd) getApplicationReferenceCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetApplicationReferenceCollection(req, filters)
}

func (n *getApplicationReferenceCollectionCmd) doGetApplicationReferenceCollection(req c8y.RequestOptions, filters *JSONFilters) error {
