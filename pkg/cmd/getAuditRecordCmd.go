...
func (n *getAuditRecordCmd) getAuditRecord(cmd *cobra.Command, args []string) error {
	...
	return n.doGetAuditRecord("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getAuditRecordCmd) doGetAuditRecord(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
