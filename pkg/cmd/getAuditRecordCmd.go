...
func (n *getAuditRecordCmd) getAuditRecord(cmd *cobra.Command, args []string) error {
	...
	return n.doGetAuditRecord(req, outputfile, filters)
}

func (n *getAuditRecordCmd) doGetAuditRecord(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
