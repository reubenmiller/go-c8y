...
func (n *getBinaryCollectionCmd) getBinaryCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetBinaryCollection(req, outputfile, filters)
}

func (n *getBinaryCollectionCmd) doGetBinaryCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
