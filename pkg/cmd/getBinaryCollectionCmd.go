...
func (n *getBinaryCollectionCmd) getBinaryCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetBinaryCollection("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getBinaryCollectionCmd) doGetBinaryCollection(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
