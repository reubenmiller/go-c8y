...
func (n *getCurrentApplicationCmd) getCurrentApplication(cmd *cobra.Command, args []string) error {
	...
	return n.doGetCurrentApplication(req, outputfile, filters)
}

func (n *getCurrentApplicationCmd) doGetCurrentApplication(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
