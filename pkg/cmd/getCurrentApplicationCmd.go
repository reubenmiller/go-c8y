...
func (n *getCurrentApplicationCmd) getCurrentApplication(cmd *cobra.Command, args []string) error {
	...
	return n.doGetCurrentApplication("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getCurrentApplicationCmd) doGetCurrentApplication(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
