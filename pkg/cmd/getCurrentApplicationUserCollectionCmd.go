...
func (n *getCurrentApplicationUserCollectionCmd) getCurrentApplicationUserCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetCurrentApplicationUserCollection(req, outputfile, filters)
}

func (n *getCurrentApplicationUserCollectionCmd) doGetCurrentApplicationUserCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
