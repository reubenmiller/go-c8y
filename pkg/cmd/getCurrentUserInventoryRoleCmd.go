...
func (n *getCurrentUserInventoryRoleCmd) getCurrentUserInventoryRole(cmd *cobra.Command, args []string) error {
	...
	return n.doGetCurrentUserInventoryRole(req, outputfile, filters)
}

func (n *getCurrentUserInventoryRoleCmd) doGetCurrentUserInventoryRole(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
