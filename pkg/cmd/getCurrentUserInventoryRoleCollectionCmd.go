...
func (n *getCurrentUserInventoryRoleCollectionCmd) getCurrentUserInventoryRoleCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetCurrentUserInventoryRoleCollection(req, outputfile, filters)
}

func (n *getCurrentUserInventoryRoleCollectionCmd) doGetCurrentUserInventoryRoleCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
