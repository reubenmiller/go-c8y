...
func (n *getDataBrokerCmd) getDataBroker(cmd *cobra.Command, args []string) error {
	...
	return n.doGetDataBroker(req, outputfile, filters)
}

func (n *getDataBrokerCmd) doGetDataBroker(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
