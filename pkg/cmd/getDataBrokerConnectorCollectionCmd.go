...
func (n *getDataBrokerConnectorCollectionCmd) getDataBrokerConnectorCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetDataBrokerConnectorCollection(req, outputfile, filters)
}

func (n *getDataBrokerConnectorCollectionCmd) doGetDataBrokerConnectorCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
