...
func (n *getDeviceGroupCmd) getDeviceGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doGetDeviceGroup(req, outputfile, filters)
}

func (n *getDeviceGroupCmd) doGetDeviceGroup(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
