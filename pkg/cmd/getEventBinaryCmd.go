...
func (n *getEventBinaryCmd) getEventBinary(cmd *cobra.Command, args []string) error {
	...
	return n.doGetEventBinary(req, outputfile, filters)
}

func (n *getEventBinaryCmd) doGetEventBinary(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
