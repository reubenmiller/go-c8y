...
func (n *getEventCmd) getEvent(cmd *cobra.Command, args []string) error {
	...
	return n.doGetEvent("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getEventCmd) doGetEvent(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
