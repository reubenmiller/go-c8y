...
func (n *getEventCollectionCmd) getEventCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetEventCollection(req, outputfile, filters)
}

func (n *getEventCollectionCmd) doGetEventCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
