...
func (n *getExternalIDCmd) getExternalID(cmd *cobra.Command, args []string) error {
	...
	return n.doGetExternalID("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getExternalIDCmd) doGetExternalID(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
