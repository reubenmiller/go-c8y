...
func (n *getExternalIDCollectionCmd) getExternalIDCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetExternalIDCollection(req, outputfile, filters)
}

func (n *getExternalIDCollectionCmd) doGetExternalIDCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
