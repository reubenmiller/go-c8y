...
func (n *getExternalIDCollectionCmd) getExternalIDCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetExternalIDCollection(req, filters)
}

func (n *getExternalIDCollectionCmd) doGetExternalIDCollection(req c8y.RequestOptions, filters *JSONFilters) error {
