...
func (n *getGroupByNameCmd) getGroupByName(cmd *cobra.Command, args []string) error {
	...
	return n.doGetGroupByName("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getGroupByNameCmd) doGetGroupByName(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
