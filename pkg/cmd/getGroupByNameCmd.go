...
func (n *getGroupByNameCmd) getGroupByName(cmd *cobra.Command, args []string) error {
	...
	return n.doGetGroupByName(req, outputfile, filters)
}

func (n *getGroupByNameCmd) doGetGroupByName(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
