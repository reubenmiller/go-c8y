...
func (n *getGroupCmd) getGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doGetGroup("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getGroupCmd) doGetGroup(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
