...
func (n *getGroupCollectionCmd) getGroupCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetGroupCollection(req, outputfile, filters)
}

func (n *getGroupCollectionCmd) doGetGroupCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
