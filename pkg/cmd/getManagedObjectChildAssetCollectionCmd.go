...
func (n *getManagedObjectChildAssetCollectionCmd) getManagedObjectChildAssetCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetManagedObjectChildAssetCollection(req, outputfile, filters)
}

func (n *getManagedObjectChildAssetCollectionCmd) doGetManagedObjectChildAssetCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
