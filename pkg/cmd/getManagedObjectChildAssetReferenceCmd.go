...
func (n *getManagedObjectChildAssetReferenceCmd) getManagedObjectChildAssetReference(cmd *cobra.Command, args []string) error {
	...
	return n.doGetManagedObjectChildAssetReference(req, filters)
}

func (n *getManagedObjectChildAssetReferenceCmd) doGetManagedObjectChildAssetReference(req c8y.RequestOptions, filters *JSONFilters) error {
