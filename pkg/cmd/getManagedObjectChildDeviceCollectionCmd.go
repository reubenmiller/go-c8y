...
func (n *getManagedObjectChildDeviceCollectionCmd) getManagedObjectChildDeviceCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetManagedObjectChildDeviceCollection("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getManagedObjectChildDeviceCollectionCmd) doGetManagedObjectChildDeviceCollection(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
