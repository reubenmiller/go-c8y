...
func (n *getManagedObjectChildDeviceCollectionCmd) getManagedObjectChildDeviceCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetManagedObjectChildDeviceCollection(req, filters)
}

func (n *getManagedObjectChildDeviceCollectionCmd) doGetManagedObjectChildDeviceCollection(req c8y.RequestOptions, filters *JSONFilters) error {
