...
func (n *getManagedObjectChildDeviceReferenceCmd) getManagedObjectChildDeviceReference(cmd *cobra.Command, args []string) error {
	...
	return n.doGetManagedObjectChildDeviceReference(req, outputfile, filters)
}

func (n *getManagedObjectChildDeviceReferenceCmd) doGetManagedObjectChildDeviceReference(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
