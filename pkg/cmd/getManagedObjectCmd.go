...
func (n *getManagedObjectCmd) getManagedObject(cmd *cobra.Command, args []string) error {
	...
	return n.doGetManagedObject("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getManagedObjectCmd) doGetManagedObject(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
