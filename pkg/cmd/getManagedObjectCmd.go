...
func (n *getManagedObjectCmd) getManagedObject(cmd *cobra.Command, args []string) error {
	...
	return n.doGetManagedObject(req, outputfile, filters)
}

func (n *getManagedObjectCmd) doGetManagedObject(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
