...
func (n *getManagedObjectCollectionCmd) getManagedObjectCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetManagedObjectCollection(req, filters)
}

func (n *getManagedObjectCollectionCmd) doGetManagedObjectCollection(req c8y.RequestOptions, filters *JSONFilters) error {
