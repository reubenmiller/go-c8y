...
func (n *getManagedObjectCollectionCmd) getManagedObjectCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetManagedObjectCollection("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getManagedObjectCollectionCmd) doGetManagedObjectCollection(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
