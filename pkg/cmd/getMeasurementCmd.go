...
func (n *getMeasurementCmd) getMeasurement(cmd *cobra.Command, args []string) error {
	...
	return n.doGetMeasurement(req, outputfile, filters)
}

func (n *getMeasurementCmd) doGetMeasurement(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
