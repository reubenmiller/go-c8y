...
func (n *getMicroserviceBootstrapUserCmd) getMicroserviceBootstrapUser(cmd *cobra.Command, args []string) error {
	...
	return n.doGetMicroserviceBootstrapUser(req, outputfile, filters)
}

func (n *getMicroserviceBootstrapUserCmd) doGetMicroserviceBootstrapUser(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
