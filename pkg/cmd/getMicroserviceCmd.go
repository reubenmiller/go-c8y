...
func (n *getMicroserviceCmd) getMicroservice(cmd *cobra.Command, args []string) error {
	...
	return n.doGetMicroservice(req, outputfile, filters)
}

func (n *getMicroserviceCmd) doGetMicroservice(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
