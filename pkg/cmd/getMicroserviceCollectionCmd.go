...
func (n *getMicroserviceCollectionCmd) getMicroserviceCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetMicroserviceCollection(req, outputfile, filters)
}

func (n *getMicroserviceCollectionCmd) doGetMicroserviceCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
