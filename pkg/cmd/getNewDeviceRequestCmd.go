...
func (n *getNewDeviceRequestCmd) getNewDeviceRequest(cmd *cobra.Command, args []string) error {
	...
	return n.doGetNewDeviceRequest(req, outputfile, filters)
}

func (n *getNewDeviceRequestCmd) doGetNewDeviceRequest(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
