...
func (n *getOperationCmd) getOperation(cmd *cobra.Command, args []string) error {
	...
	return n.doGetOperation("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getOperationCmd) doGetOperation(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
