...
func (n *getOperationCmd) getOperation(cmd *cobra.Command, args []string) error {
	...
	return n.doGetOperation(req, outputfile, filters)
}

func (n *getOperationCmd) doGetOperation(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
