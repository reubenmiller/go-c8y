...
func (n *getOperationCollectionCmd) getOperationCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetOperationCollection(req, filters)
}

func (n *getOperationCollectionCmd) doGetOperationCollection(req c8y.RequestOptions, filters *JSONFilters) error {
