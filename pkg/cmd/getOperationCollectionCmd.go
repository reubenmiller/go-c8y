...
func (n *getOperationCollectionCmd) getOperationCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetOperationCollection("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getOperationCollectionCmd) doGetOperationCollection(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
