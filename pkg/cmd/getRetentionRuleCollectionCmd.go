...
func (n *getRetentionRuleCollectionCmd) getRetentionRuleCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetRetentionRuleCollection("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getRetentionRuleCollectionCmd) doGetRetentionRuleCollection(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
