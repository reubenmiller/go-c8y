...
func (n *getRoleCollectionCmd) getRoleCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetRoleCollection("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getRoleCollectionCmd) doGetRoleCollection(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
