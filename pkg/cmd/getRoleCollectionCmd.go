...
func (n *getRoleCollectionCmd) getRoleCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetRoleCollection(req, outputfile, filters)
}

func (n *getRoleCollectionCmd) doGetRoleCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
