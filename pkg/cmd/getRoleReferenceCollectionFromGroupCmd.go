...
func (n *getRoleReferenceCollectionFromGroupCmd) getRoleReferenceCollectionFromGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doGetRoleReferenceCollectionFromGroup(req, outputfile, filters)
}

func (n *getRoleReferenceCollectionFromGroupCmd) doGetRoleReferenceCollectionFromGroup(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
