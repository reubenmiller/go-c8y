...
func (n *getRoleReferenceCollectionFromGroupCmd) getRoleReferenceCollectionFromGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doGetRoleReferenceCollectionFromGroup("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getRoleReferenceCollectionFromGroupCmd) doGetRoleReferenceCollectionFromGroup(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
	...
	if resp != nil && resp.JSONData != nil {
		...
		if filters != nil && !globalFlagRaw {
			responseText = filters.Apply(*resp.JSONData, "references")
		} else {
