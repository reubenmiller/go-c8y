...
func (n *getRoleReferenceCollectionFromGroupCmd) getRoleReferenceCollectionFromGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doGetRoleReferenceCollectionFromGroup(req, filters)
}

func (n *getRoleReferenceCollectionFromGroupCmd) doGetRoleReferenceCollectionFromGroup(req c8y.RequestOptions, filters *JSONFilters) error {
