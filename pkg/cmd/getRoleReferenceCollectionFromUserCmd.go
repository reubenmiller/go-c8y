...
func (n *getRoleReferenceCollectionFromUserCmd) getRoleReferenceCollectionFromUser(cmd *cobra.Command, args []string) error {
	...
	return n.doGetRoleReferenceCollectionFromUser(req, outputfile, filters)
}

func (n *getRoleReferenceCollectionFromUserCmd) doGetRoleReferenceCollectionFromUser(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
