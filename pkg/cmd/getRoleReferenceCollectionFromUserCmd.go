...
func (n *getRoleReferenceCollectionFromUserCmd) getRoleReferenceCollectionFromUser(cmd *cobra.Command, args []string) error {
	...
	return n.doGetRoleReferenceCollectionFromUser(req, filters)
}

func (n *getRoleReferenceCollectionFromUserCmd) doGetRoleReferenceCollectionFromUser(req c8y.RequestOptions, filters *JSONFilters) error {
