...
func (n *getSystemOptionCmd) getSystemOption(cmd *cobra.Command, args []string) error {
	...
	return n.doGetSystemOption("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getSystemOptionCmd) doGetSystemOption(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
