...
func (n *getSystemOptionCmd) getSystemOption(cmd *cobra.Command, args []string) error {
	...
	return n.doGetSystemOption(req, outputfile, filters)
}

func (n *getSystemOptionCmd) doGetSystemOption(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
