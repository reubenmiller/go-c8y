...
func (n *getSystemOptionCollectionCmd) getSystemOptionCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetSystemOptionCollection(req, filters)
}

func (n *getSystemOptionCollectionCmd) doGetSystemOptionCollection(req c8y.RequestOptions, filters *JSONFilters) error {
