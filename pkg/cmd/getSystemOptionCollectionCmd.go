...
func (n *getSystemOptionCollectionCmd) getSystemOptionCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetSystemOptionCollection(req, outputfile, filters)
}

func (n *getSystemOptionCollectionCmd) doGetSystemOptionCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
