...
func (n *getTenantCmd) getTenant(cmd *cobra.Command, args []string) error {
	...
	return n.doGetTenant("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getTenantCmd) doGetTenant(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
