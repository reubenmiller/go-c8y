...
func (n *getTenantCollectionCmd) getTenantCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetTenantCollection(req, outputfile, filters)
}

func (n *getTenantCollectionCmd) doGetTenantCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
