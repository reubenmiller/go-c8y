...
func (n *getTenantOptionCmd) getTenantOption(cmd *cobra.Command, args []string) error {
	...
	return n.doGetTenantOption(req, outputfile, filters)
}

func (n *getTenantOptionCmd) doGetTenantOption(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
