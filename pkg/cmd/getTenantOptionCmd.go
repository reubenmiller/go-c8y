...
func (n *getTenantOptionCmd) getTenantOption(cmd *cobra.Command, args []string) error {
	...
	return n.doGetTenantOption("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getTenantOptionCmd) doGetTenantOption(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
