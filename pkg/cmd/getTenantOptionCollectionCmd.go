...
func (n *getTenantOptionCollectionCmd) getTenantOptionCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetTenantOptionCollection(req, outputfile, filters)
}

func (n *getTenantOptionCollectionCmd) doGetTenantOptionCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
