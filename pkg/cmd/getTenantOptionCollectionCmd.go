...
func (n *getTenantOptionCollectionCmd) getTenantOptionCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetTenantOptionCollection(req, filters)
}

func (n *getTenantOptionCollectionCmd) doGetTenantOptionCollection(req c8y.RequestOptions, filters *JSONFilters) error {
