...
func (n *getTenantUsageStatisticsCollectionCmd) getTenantUsageStatisticsCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetTenantUsageStatisticsCollection("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getTenantUsageStatisticsCollectionCmd) doGetTenantUsageStatisticsCollection(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
