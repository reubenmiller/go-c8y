...
func (n *getTenantUsageStatisticsCollectionCmd) getTenantUsageStatisticsCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetTenantUsageStatisticsCollection(req, outputfile, filters)
}

func (n *getTenantUsageStatisticsCollectionCmd) doGetTenantUsageStatisticsCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
