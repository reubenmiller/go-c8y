...
func (n *getTenantUsageStatisticsSummaryCollectionCmd) getTenantUsageStatisticsSummaryCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doGetTenantUsageStatisticsSummaryCollection(req, outputfile, filters)
}

func (n *getTenantUsageStatisticsSummaryCollectionCmd) doGetTenantUsageStatisticsSummaryCollection(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
