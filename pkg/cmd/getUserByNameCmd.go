...
func (n *getUserByNameCmd) getUserByName(cmd *cobra.Command, args []string) error {
	...
	return n.doGetUserByName("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getUserByNameCmd) doGetUserByName(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
