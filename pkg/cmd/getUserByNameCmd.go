...
func (n *getUserByNameCmd) getUserByName(cmd *cobra.Command, args []string) error {
	...
	return n.doGetUserByName(req, outputfile, filters)
}

func (n *getUserByNameCmd) doGetUserByName(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
