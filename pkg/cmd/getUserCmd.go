...
func (n *getUserCmd) getUser(cmd *cobra.Command, args []string) error {
	...
	return n.doGetUser("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getUserCmd) doGetUser(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
