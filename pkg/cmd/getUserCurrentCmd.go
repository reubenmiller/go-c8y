...
func (n *getUserCurrentCmd) getUserCurrent(cmd *cobra.Command, args []string) error {
	...
	return n.doGetUserCurrent(req, outputfile, filters)
}

func (n *getUserCurrentCmd) doGetUserCurrent(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
