...
func (n *getUsersInGroupCmd) getUsersInGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doGetUsersInGroup(req, outputfile, filters)
}

func (n *getUsersInGroupCmd) doGetUsersInGroup(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
