...
func (n *getUsersInGroupCmd) getUsersInGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doGetUsersInGroup("GET", path, queryValue, body.GetMap(), filters)
}

func (n *getUsersInGroupCmd) doGetUsersInGroup(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
