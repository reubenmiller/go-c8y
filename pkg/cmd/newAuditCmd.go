...
func (n *newAuditCmd) newAudit(cmd *cobra.Command, args []string) error {
	...
	return n.doNewAudit("POST", path, queryValue, body.GetMap(), filters)
}

func (n *newAuditCmd) doNewAudit(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
