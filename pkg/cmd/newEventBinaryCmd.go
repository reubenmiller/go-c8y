...
func (n *newEventBinaryCmd) newEventBinary(cmd *cobra.Command, args []string) error {
	...
	return n.doNewEventBinary(req, outputfile, filters)
}

func (n *newEventBinaryCmd) doNewEventBinary(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
