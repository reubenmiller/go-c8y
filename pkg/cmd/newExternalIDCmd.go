...
func (n *newExternalIDCmd) newExternalID(cmd *cobra.Command, args []string) error {
	...
	return n.doNewExternalID(req, outputfile, filters)
}

func (n *newExternalIDCmd) doNewExternalID(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
