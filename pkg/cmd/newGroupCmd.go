...
func (n *newGroupCmd) newGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doNewGroup("POST", path, queryValue, body.GetMap(), filters)
}

func (n *newGroupCmd) doNewGroup(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
