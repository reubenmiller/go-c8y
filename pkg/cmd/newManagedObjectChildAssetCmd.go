...
func (n *newManagedObjectChildAssetCmd) newManagedObjectChildAsset(cmd *cobra.Command, args []string) error {
	...
	return n.doNewManagedObjectChildAsset(req, outputfile, filters)
}

func (n *newManagedObjectChildAssetCmd) doNewManagedObjectChildAsset(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
