...
func (n *newManagedObjectChildAssetCmd) newManagedObjectChildAsset(cmd *cobra.Command, args []string) error {
	...
	return n.doNewManagedObjectChildAsset(req, filters)
}

func (n *newManagedObjectChildAssetCmd) doNewManagedObjectChildAsset(req c8y.RequestOptions, filters *JSONFilters) error {
