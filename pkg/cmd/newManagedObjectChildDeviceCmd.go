...
func (n *newManagedObjectChildDeviceCmd) newManagedObjectChildDevice(cmd *cobra.Command, args []string) error {
	...
	return n.doNewManagedObjectChildDevice(req, outputfile, filters)
}

func (n *newManagedObjectChildDeviceCmd) doNewManagedObjectChildDevice(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
