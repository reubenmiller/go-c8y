...
func (n *newManagedObjectCmd) newManagedObject(cmd *cobra.Command, args []string) error {
	...
	return n.doNewManagedObject(req, outputfile, filters)
}

func (n *newManagedObjectCmd) doNewManagedObject(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
