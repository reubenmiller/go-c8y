...
func (n *newMicroserviceBinaryCmd) newMicroserviceBinary(cmd *cobra.Command, args []string) error {
	...
	return n.doNewMicroserviceBinary(req, outputfile, filters)
}

func (n *newMicroserviceBinaryCmd) doNewMicroserviceBinary(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
