...
func (n *newOperationCmd) newOperation(cmd *cobra.Command, args []string) error {
	...
	return n.doNewOperation(req, outputfile, filters)
}

func (n *newOperationCmd) doNewOperation(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
