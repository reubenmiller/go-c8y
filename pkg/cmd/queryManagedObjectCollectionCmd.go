...
func (n *queryManagedObjectCollectionCmd) queryManagedObjectCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doQueryManagedObjectCollection(req, filters)
}

func (n *queryManagedObjectCollectionCmd) doQueryManagedObjectCollection(req c8y.RequestOptions, filters *JSONFilters) error {
