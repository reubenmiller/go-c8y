...
func (n *registerNewDeviceCmd) registerNewDevice(cmd *cobra.Command, args []string) error {
	...
	return n.doRegisterNewDevice(req, outputfile, filters)
}

func (n *registerNewDeviceCmd) doRegisterNewDevice(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
