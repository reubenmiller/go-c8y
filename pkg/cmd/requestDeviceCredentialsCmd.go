...
func (n *requestDeviceCredentialsCmd) requestDeviceCredentials(cmd *cobra.Command, args []string) error {
	...
	return n.doRequestDeviceCredentials(req, outputfile, filters)
}

func (n *requestDeviceCredentialsCmd) doRequestDeviceCredentials(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
