...
func (n *updateAlarmCollectionCmd) updateAlarmCollection(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateAlarmCollection("PUT", path, queryValue, body.GetMap(), filters)
}

func (n *updateAlarmCollectionCmd) doUpdateAlarmCollection(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
