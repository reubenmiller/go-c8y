...
func (n *updateApplicationCmd) updateApplication(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateApplication(req, outputfile, filters)
}

func (n *updateApplicationCmd) doUpdateApplication(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
