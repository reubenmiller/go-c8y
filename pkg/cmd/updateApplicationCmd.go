...
func (n *updateApplicationCmd) updateApplication(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateApplication("PUT", path, queryValue, body.GetMap(), filters)
}

func (n *updateApplicationCmd) doUpdateApplication(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
