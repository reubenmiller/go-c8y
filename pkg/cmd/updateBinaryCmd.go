...
func (n *updateBinaryCmd) updateBinary(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateBinary(req, outputfile, filters)
}

func (n *updateBinaryCmd) doUpdateBinary(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
