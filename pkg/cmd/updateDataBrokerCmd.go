...
func (n *updateDataBrokerCmd) updateDataBroker(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateDataBroker(req, outputfile, filters)
}

func (n *updateDataBrokerCmd) doUpdateDataBroker(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
