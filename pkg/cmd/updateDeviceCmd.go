...
func (n *updateDeviceCmd) updateDevice(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateDevice(req, outputfile, filters)
}

func (n *updateDeviceCmd) doUpdateDevice(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
