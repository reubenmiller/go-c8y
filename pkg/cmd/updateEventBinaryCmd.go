...
func (n *updateEventBinaryCmd) updateEventBinary(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateEventBinary(req, outputfile, filters)
}

func (n *updateEventBinaryCmd) doUpdateEventBinary(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
