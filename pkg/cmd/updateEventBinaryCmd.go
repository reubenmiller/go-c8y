...
func (n *updateEventBinaryCmd) updateEventBinary(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateEventBinary("PUT", path, queryValue, body.GetMap(), filters)
}

func (n *updateEventBinaryCmd) doUpdateEventBinary(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
