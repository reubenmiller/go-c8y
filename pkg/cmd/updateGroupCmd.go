...
func (n *updateGroupCmd) updateGroup(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateGroup("PUT", path, queryValue, body.GetMap(), filters)
}

func (n *updateGroupCmd) doUpdateGroup(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
