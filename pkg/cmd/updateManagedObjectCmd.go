...
func (n *updateManagedObjectCmd) updateManagedObject(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateManagedObject("PUT", path, queryValue, body.GetMap(), filters)
}

func (n *updateManagedObjectCmd) doUpdateManagedObject(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
