...
func (n *updateOperationCmd) updateOperation(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateOperation(req, outputfile, filters)
}

func (n *updateOperationCmd) doUpdateOperation(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
