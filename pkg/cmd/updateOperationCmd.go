...
func (n *updateOperationCmd) updateOperation(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateOperation("PUT", path, queryValue, body.GetMap(), filters)
}

func (n *updateOperationCmd) doUpdateOperation(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
