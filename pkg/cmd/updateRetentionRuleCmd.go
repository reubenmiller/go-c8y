...
func (n *updateRetentionRuleCmd) updateRetentionRule(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateRetentionRule(req, outputfile, filters)
}

func (n *updateRetentionRuleCmd) doUpdateRetentionRule(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
