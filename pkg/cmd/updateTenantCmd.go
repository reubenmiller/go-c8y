...
func (n *updateTenantCmd) updateTenant(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateTenant(req, outputfile, filters)
}

func (n *updateTenantCmd) doUpdateTenant(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
