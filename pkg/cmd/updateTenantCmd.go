...
func (n *updateTenantCmd) updateTenant(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateTenant("PUT", path, queryValue, body.GetMap(), filters)
}

func (n *updateTenantCmd) doUpdateTenant(method string, path string, query string, body map[string]interface{}, filters *JSONFilters) error {
