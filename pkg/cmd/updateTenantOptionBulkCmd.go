...
func (n *updateTenantOptionBulkCmd) updateTenantOptionBulk(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateTenantOptionBulk(req, filters)
}

func (n *updateTenantOptionBulkCmd) doUpdateTenantOptionBulk(req c8y.RequestOptions, filters *JSONFilters) error {
