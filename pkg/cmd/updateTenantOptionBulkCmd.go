...
func (n *updateTenantOptionBulkCmd) updateTenantOptionBulk(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateTenantOptionBulk(req, outputfile, filters)
}

func (n *updateTenantOptionBulkCmd) doUpdateTenantOptionBulk(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
