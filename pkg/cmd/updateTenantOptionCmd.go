...
func (n *updateTenantOptionCmd) updateTenantOption(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateTenantOption(req, outputfile, filters)
}

func (n *updateTenantOptionCmd) doUpdateTenantOption(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
