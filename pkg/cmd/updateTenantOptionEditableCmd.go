...
func (n *updateTenantOptionEditableCmd) updateTenantOptionEditable(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateTenantOptionEditable(req, outputfile, filters)
}

func (n *updateTenantOptionEditableCmd) doUpdateTenantOptionEditable(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
