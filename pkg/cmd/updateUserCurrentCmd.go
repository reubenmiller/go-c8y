...
func (n *updateUserCurrentCmd) updateUserCurrent(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateUserCurrent(req, outputfile, filters)
}

func (n *updateUserCurrentCmd) doUpdateUserCurrent(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
